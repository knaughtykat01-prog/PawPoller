...
**Current version:** 2.16.1 (Mobile Mode Phase 2 — iOS 16px input zoom fix, editor toolbar ⋯ More collapse, bottom nav Editor entry, stat cards 1-col strips, page header tighten, modals full-screen on mobile, submission cards 1-col, on top of 2.16.0's mobile-mode toggle + Phase 1)
