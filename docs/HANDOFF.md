...
**Current version:** 2.16.0 (Mobile Mode — Settings → Appearance toggle, editor single-panel switcher, anchor toolbar swipe strip, publish-check chapter cards, sidebar `:hover` lockout for touch, safe-area-inset-top, publish-check modal backdrop guard, on top of 2.15.0's per-platform tag tabs)
