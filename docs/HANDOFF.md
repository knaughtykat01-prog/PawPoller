...
**Current version:** 2.15.0 (per-platform tag tabs for FA / Weasyl / AO3 / SQW with FA char-string counter + Populate from Default backfill, on top of 2.14.10's mobile metadata-drawer fix and 2.14.9's FA draft-detection probe)
