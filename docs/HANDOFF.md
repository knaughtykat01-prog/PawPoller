...
**Deployed to:** GCP instance `pawpoller` (zone `us-east1-c`), running 2.22.14. **Master is at 2.26.1 — needs `pawupdate` to ship** (4-version gap: the 2.23.0 dashboard UX batch, 2.23.1-2.23.3 AO3/SF/FAExport fixes, 2.24.0 Inno installer, 2.25.0 Linux AppImage, 2.26.0 in-app Uninstall, plus the 2.26.1 FA error-message clarification that came out of investigating today's FAExport outage).
