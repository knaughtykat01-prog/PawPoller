...
const Components = {
    ...
    platformEmptyState(code, opts = {}) {
        ...
        const emojis = {
            ...
            ik: '\u{1F3AF}', bsky: '\u{1F98B}', tw: '\u{1F426}', mast: '\u{1F418}',
        };
